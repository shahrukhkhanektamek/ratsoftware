                                    ...
                                    <div class="card-body frm">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <select class="form-select mb-3" name="state_id" required id="select-state">
                                                    <option value="" >Select</option>
                                                    <?php ($state = DB::table("countries")->where(["id"=>@$row->state_id,])->first()); ?>
                                                    <?php if(!empty($state)): ?>
...
</html><?php /**PATH C:\xamp\htdocs\projects\ratsoftware\resources\views/admin/city/form.blade.php ENDPATH**/ ?>