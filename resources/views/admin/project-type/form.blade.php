                                    ...
                                    <div class="card-body frm">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <input type="number" class="form-control" placeholder="Enter Post Images" name="total_image" value="{{@$row->total_image}}" required>
                                            </div>
                                            <div class="col-lg-6">
                                                <label for="formFile" class="form-label">Recee Required</label>
                                                <select class="form-select mb-3" name="is_recee">
                                                    <option value="0" @if(!empty(@$row) && @$row->is_recee==0)selected @endif >No</option>
                                                    <option value="1" @if(!empty(@$row) && @$row->is_recee==1)selected @endif >Yes</option>
                                                </select>
                                            </div>
                                            <div class="col-lg-6">
