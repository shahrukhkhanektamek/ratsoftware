...
class ItemController extends Controller
{
     protected $arr_values = array(
        ...
        "folder_name"=>'/item',
        "upload_path"=>'upload/',
        "page_name"=>'item-detail.blade.php',
        "keys"=>'id,name',
    ...
    public function load_data(Request $request)
    {
      ...
      $data_list = Item::where(['status' => $status])->orderBy('id',$order_by);
    ...
    public function update(Request $request)
    {
        ...
        if(empty($id)) $data = new Item;
        else $data = Item::find($id);
