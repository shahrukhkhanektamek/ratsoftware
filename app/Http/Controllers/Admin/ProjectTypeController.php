...
class ProjectTypeController extends Controller
{
     protected $arr_values = array(
        ...
        "folder_name"=>'/project-type',
        "upload_path"=>'upload/',
        "page_name"=>'project-type.blade.php',
        "keys"=>'id,name',
    ...
    public function load_data(Request $request)
    {
      ...
      $data_list = ProjectType::where(['status' => $status])->orderBy('id',$order_by);
    ...
    {   
        ...
        $row = ProjectType::where(["id"=>$id,])->first();
        if(!empty($row))
        {
            return view($this->arr_values['folder_name'].'/form',compact('data','row'));
        }
    ...
    public function update(Request $request)
    {
        ...
        if(empty($id)) $data = new ProjectType;
        else $data = ProjectType::find($id);
        ...
        $data->total_image = $request->total_image;
        $data->is_recee = $request->is_recee;
