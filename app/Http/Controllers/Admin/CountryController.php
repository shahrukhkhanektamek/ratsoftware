...
class CountryController extends Controller
{
     protected $arr_values = array(
        ...
        "folder_name"=>'/country',
        "upload_path"=>'upload/',
        "page_name"=>'country-detail.blade.php',
        "keys"=>'id,name',
    ...
    public function load_data(Request $request)
    {
      ...
      $data_list = Country::where(['status' => $status])->orderBy('id',$order_by);
    ...
    public function update(Request $request)
    {
        ...
        if(empty($id)) $data = new Country;
        else $data = Country::find($id);
